...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <?php define('MENU_SEL', 'basemaps.php');
				...
				<table class="table table-bordered">
					<thead>
						<tr>
							...
							<th data-name="basemap_name">basemap_name</th>
                                                        <th data-name="basemap_url">basemap_url</th>
					...
					<tbody> <?php while($row = pg_fetch_object($rows)): ?> <tr data-id="<?=$row->id?>" align="left">
							<td><?=$row->id?></td>
							<td><?=$row->basemap_name?></td>
                                                        <td><?=$row->basemap_url?></td>
							<td>
								<a class="add" title="Add" data-toggle="tooltip">
									<i class="material-icons">&#xE03B;</i>
								</a>
