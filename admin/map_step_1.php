...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <?php define('MENU_SEL', 'map_step_1.php');
            ...
            <div class="page-breadcrumb" style="padding-left:30px; padding-right: 30px; padding-top:0px; padding-bottom: 0px">
                <div class="row align-items-center">
                    <div class="col-6">
                        ...
                        <h1 class="mb-0 fw-bold">Select Data Source:</h1>
                    </div>
                    <div class="col-6">
...
<!--<img src="assets/images/geoserver.jpg" style="max-width: 55%">-->
              ...
              <a
                ...
                <div class="card-body" style="text-decoration: none">
                  ...
                  <div class="mt-4">
                    <h4 class="card-title mb-1 text-white" style="text-decoration: none">pg_featursev</h4>
                    <h6 class="card-text fw-normal text-white-50" style="text-decoration: none">
                      pg_featursev choropleth map
                    </h6>
                  </div>
                </div>
              </a>
            ...
            <div class="col-md-4 col-xl-2 d-flex align-items-stretch">
<!--<img src="assets/images/postgis.jpg" style="max-width: 50%">-->
              ...
              >
                <div class="card-body">
                  ...
                  <div class="mt-4">
                    <h4 class="card-title mb-1 text-white">pg_tileserv</h4>
                    <h6 class="card-text fw-normal text-white-50">
                      PostGIS choropleth map
                    </h6>
                  </div>
                </div>
              </a>
            ...
            <div class="col-md-4 col-xl-2 d-flex align-items-stretch">
              ...
              >
                <div class="card-body">
                  ...
                  <div class="mt-4">
                    <h4 class="card-title mb-1 text-white">PostGIS</h4>
                    <h6 class="card-text fw-normal text-white-50">
