<?php
    class Report_Class
    {
        ...
        function create($data)
        {
             ...
             (repname,url,datasource,download_only,outname,name,description,is_grouped) "."VALUES('".
             $this->cleanData($data['repname'])."','".
             $this->cleanData($data['url'])."','".
             $this->cleanData($data['datasource'])."','".
       ...
       function update($data=array())
       {
          ...
          $this->cleanData($data['repname'])."', url='".
          $this->cleanData($data['url'])."', datasource='".
          $this->cleanData($data['datasource'])."', download_only='".
