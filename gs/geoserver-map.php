<?PHP
    ...
    $full_url = "https://" . $map_row['url'] . "/geoserver/" . $map_row['collection'] . "/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=" . $map_row['collection'] . ":" . $map_row[cql] . "&maxFeatures=3000&outputFormat=application/json";
?>
...
<header>
  ...
  <div class="navbar navbar-dark bg-dark shadow-sm" style="background-color:coral!important">
    <div class="container">
